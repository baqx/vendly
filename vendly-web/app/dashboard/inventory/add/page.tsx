        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white dark:bg-card rounded-[4px] p-8 border border-border/50 shadow-none space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Main Dropzone */}
                <div className="relative h-64 border-2 border-dashed border-green-300 dark:border-green-900/50 bg-green-50/50 dark:bg-green-950/20 rounded-[4px] flex flex-col items-center justify-center text-center cursor-pointer hover:bg-green-50 dark:hover:bg-green-900/30 transition-colors group">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[1, 2].map((i) => (
                    <div key={i} className="aspect-square rounded-[4px] bg-[#F4F6F9] dark:bg-muted/30 border border-border/40 flex items-center justify-center cursor-pointer hover:bg-muted transition-colors">
      ...
      <div className="mt-8">
        <div className="bg-white dark:bg-card border border-border/50 shadow-none rounded-[4px] p-4 flex flex-col sm:flex-row items-center justify-between gap-4 w-full">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            ...
            <button className="flex-1 sm:flex-none bg-green-700 hover:bg-green-800 text-white px-8 py-3 rounded-[4px] font-extrabold flex items-center justify-center gap-2 transition-all shadow-none hover:scale-[1.02] active:scale-95">
              <UploadCloud size={18} />
