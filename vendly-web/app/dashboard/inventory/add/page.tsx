...
export default function AddProductPage() {
  ...
  return (
    <div className="relative flex flex-col pt-2 pb-16">
      <div className="space-y-8 flex-1">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white dark:bg-card rounded-[8px] p-8 border border-border/50 shadow-none space-y-6">
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full px-5 py-3 rounded-[8px] border border-border/40 bg-[#F4F6F9] dark:bg-muted/40 focus:ring-2 focus:ring-green-600/20 focus:border-green-600/30 outline-none font-medium text-foreground transition-all placeholder:text-muted-foreground/60"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="w-full rounded-[8px] border border-border/40 bg-[#F4F6F9] dark:bg-muted/40 overflow-hidden flex flex-col focus-within:ring-2 focus-within:ring-green-600/20 focus-within:border-green-600/30 transition-all">
                    {/* Rich text toolbar */}
            ...
            <div className="bg-white dark:bg-card rounded-[8px] p-8 border border-border/50 shadow-none space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Main Dropzone */}
                <div className="relative h-64 border-2 border-dashed border-green-300 dark:border-green-900/50 bg-green-50/50 dark:bg-green-950/20 rounded-[8px] flex flex-col items-center justify-center text-center cursor-pointer hover:bg-green-50 dark:hover:bg-green-900/30 transition-colors group">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[1, 2].map((i) => (
                    <div key={i} className="aspect-square rounded-[8px] bg-[#F4F6F9] dark:bg-muted/30 border border-border/40 flex items-center justify-center cursor-pointer hover:bg-muted transition-colors">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-card rounded-[8px] p-8 border border-border/50 shadow-none space-y-6">
              ...
              <div className="space-y-5">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      type="text" 
                      placeholder="0.00" 
                      className="w-full pl-8 pr-5 py-3 rounded-[8px] border border-border/40 bg-[#F4F6F9] dark:bg-muted/40 focus:ring-2 focus:ring-green-600/20 focus:border-green-600/30 outline-none font-bold text-foreground transition-all"
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-[#F4F6F9] dark:bg-muted/30 rounded-[8px]">
              ...
              <div className="space-y-5">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <input 
                      type="text" 
                      placeholder="COF-001" 
                      className="w-full px-4 py-3 rounded-[8px] border border-border/40 bg-[#F4F6F9] dark:bg-muted/40 focus:ring-2 focus:ring-green-600/20 focus:border-green-600/30 outline-none font-bold text-foreground transition-all"
                    />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <input type="text" placeholder="L" className="w-full px-4 py-3 text-center rounded-[8px] border border-border/40 bg-[#F4F6F9] dark:bg-muted/40 focus:ring-2 focus:ring-green-600/20 outline-none font-bold text-foreground transition-all" />
                    <input type="text" placeholder="W" className="w-full px-4 py-3 text-center rounded-[8px] border border-border/40 bg-[#F4F6F9] dark:bg-muted/40 focus:ring-2 focus:ring-green-600/20 outline-none font-bold text-foreground transition-all" />
                    <input type="text" placeholder="H" className="w-full px-4 py-3 text-center rounded-[8px] border border-border/40 bg-[#F4F6F9] dark:bg-muted/40 focus:ring-2 focus:ring-green-600/20 outline-none font-bold text-foreground transition-all" />
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="mt-8">
        <div className="bg-white dark:bg-card border border-border/50 shadow-none rounded-[8px] p-4 flex flex-col sm:flex-row items-center justify-between gap-4 w-full">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            <button className="flex-1 sm:flex-none px-6 py-3 font-bold text-foreground hover:bg-muted rounded-[8px] transition-colors">
              Discard
            </button>
            <button className="flex-1 sm:flex-none bg-green-700 hover:bg-green-800 text-white px-8 py-3 rounded-[8px] font-extrabold flex items-center justify-center gap-2 transition-all shadow-none hover:scale-[1.02] active:scale-95">
              <UploadCloud size={18} />
